...
const NAMES: Record<string, Record<Lang, string>> = {
  ...
  // 第1章の敵
  '黄巾賊兵': { ja: '黄巾賊兵', en: 'Yellow Turban Soldier', zh: '黄巾贼兵' },
  ...
  // 第2章の敵
  '西涼兵': { ja: '西涼兵', en: 'Xiliang Soldier', zh: '西凉兵' },
  ...
  // 第3章の敵
  '徐州守備兵': { ja: '徐州守備兵', en: 'Xu Province Guard', zh: '徐州守备兵' },
  ...
  // 第4章の敵
  '袁術軍兵': { ja: '袁術軍兵', en: 'Yuan Shu Soldier', zh: '袁术军兵' },
  ...
  // 第5章の敵
  '曹操軍兵': { ja: '曹操軍兵', en: 'Cao Cao Soldier', zh: '曹操军兵' },
