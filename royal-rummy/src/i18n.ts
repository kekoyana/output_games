...
const TEXTS = {
  en: {
    ...
    tutPage2Body: "[ATTACK] You can declare an ATTACK when you have melds and your LEFT is at or below the points of the FIRST DISCARD this hand (each card counts as its face value, 1-13). Attacking ends the round.\n[LEFT] The total of cards not used in any meld.",
  ...
  ja: {
    ...
    tutPage2Body: "【アタック】役を作ったうえで、残り点数が**そのラウンド最初の捨て札の点数以下**になると宣言できます（カードは数字どおりの点数、1〜13）。アタックするとラウンド終了です。\n【残り】役に使っていないカードの合計を残り点数と呼びます。",
    tutPage3Title: "役とは？",
